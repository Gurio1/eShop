        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogItemBrandId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatalogItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CatalogItems_ItemBrands_CatalogItemBrandId",
                        column: x => x.CatalogItemBrandId,
                        principalTable: "ItemBrands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatalogItems_ItemTypes_CatalogItemTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatalogItems_CatalogItemBrandId",
                table: "CatalogItems",
                column: "CatalogItemBrandId");
